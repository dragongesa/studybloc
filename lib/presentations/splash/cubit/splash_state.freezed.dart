...
class _$_SplashState extends _SplashState {
  const _$_SplashState({this.isLoading = false, this.isLoggedIn = false})
      : super._();

  factory _$_SplashState.fromJson(Map<String, dynamic> json) =>
      _$$_SplashStateFromJson(json);
...
abstract class _SplashState extends SplashState {
  const factory _SplashState({final bool isLoading, final bool isLoggedIn}) =
      _$_SplashState;
  const _SplashState._() : super._();

  factory _SplashState.fromJson(Map<String, dynamic> json) =
      _$_SplashState.fromJson;
